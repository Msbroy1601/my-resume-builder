    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">17 professionally designed templates — click the preview to explore</p>
        </div>
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200"
                  ...
                  <span className="bg-blue-600 text-white text-xs font-bold px-4 py-2 rounded-full shadow-lg pointer-events-none">
                    Use this template
                  </span>
                </div>

                {/* Zoom icon bottom-right (matches reference) */}
                <button
          ...
          >
            ...
            <div className="flex flex-col justify-between p-8 bg-white flex-shrink-0" style={{ width: '280px' }}>
              <div>
                ...
                <p className="text-sm text-gray-500 leading-relaxed mb-8">{activeTemplate.desc}</p>

                {/* Template counter */}
                <p className="text-xs text-gray-400 mb-6">
                  {(modalIdx + 1)} of {TEMPLATES.length} templates
                </p>
              </div>
            ...
            {/* RIGHT: full CV preview (scrollable) */}
            <div
